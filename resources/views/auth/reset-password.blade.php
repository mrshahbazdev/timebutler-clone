<x-guest-layout>
    @section('pageTitle', app()->getLocale() === 'de' ? 'Passwort zurücksetzen' : 'Reset Password')

    <div class="space-y-8">
        {{-- Header --}}
        <div>
            <div class="h-14 w-14 rounded-2xl bg-green-100 flex items-center justify-center mb-5">
            ...
            <h2 class="text-3xl font-bold text-gray-900 tracking-tight">
                {{ app()->getLocale() === 'de' ? 'Neues Passwort wählen' : 'Set new password' }}
            </h2>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            <div>
                <label for="password" class="block text-sm font-semibold text-gray-700 mb-1.5">
                    {{ app()->getLocale() === 'de' ? 'Neues Passwort' : 'New Password' }}
                </label>
            ...
            <button type="submit" class="btn-primary w-full flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold text-white shadow-sm">
                ...
                {{ app()->getLocale() === 'de' ? 'Passwort zurücksetzen' : 'Reset Password' }}
            </button>
        </form>
    </div>
</x-guest-layout>
