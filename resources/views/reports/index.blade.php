...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {{-- Absence Report --}}
        <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 hover:ring-blue-200 transition-all cursor-pointer">
            ...
            <p class="mt-1 text-xs text-gray-500">Absence overview and statistics</p>
        </div>
        ...
        <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 hover:ring-blue-200 transition-all cursor-pointer">
            ...
            <p class="mt-1 text-xs text-gray-500">Working hours and time sheets</p>
        </div>
        ...
        <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 hover:ring-blue-200 transition-all cursor-pointer">
            ...
            <p class="mt-1 text-xs text-gray-500">Overtime tracking and balance</p>
        </div>
    </div>
</div>
@endsection
