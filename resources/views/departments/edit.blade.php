...
<div class="max-w-xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">{{ __('app.edit') }}: {{ $department->name }}</h1>
    </div>

    <form action="{{ route('departments.update', $department) }}" method="POST" class="rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 p-6 space-y-6">
        @csrf
        @method('PUT')
